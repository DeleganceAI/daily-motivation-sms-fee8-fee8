# daily-motivation-sms-fee8-fee8

An Infinifab micro-SaaS project.
...
See [Implementation Guide](docs/implementation-guide.md) for setup instructions.

## Tech Stack

Python + FastAPI + SQLite + Twilio SMS + Railway
